...
skt_fnc_fortifyBudgetCheckChildrenSideSelect = compile preprocessFileLineNumbers "ACEX_Fortify_Selfinteract\functions\fnc_fortifyBudgetCheckChildrenSideSelect.sqf";
skt_fnc_fortifyPresetChildrenSideSelect = compile preprocessFileLineNumbers "ACEX_Fortify_Selfinteract\functions\fnc_fortifyPresetChildrenSideSelect.sqf";
skt_fnc_fortifyBudgetChildrenSideSelect = compile preprocessFileLineNumbers "ACEX_Fortify_Selfinteract\functions\fnc_fortifyBudgetChildrenSideSelect.sqf";
